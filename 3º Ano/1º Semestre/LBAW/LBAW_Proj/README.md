...
### Pete
- [x] Search events in filter
- [x] Access Statistics on Event Participation

### Gui
- [x] Delete events
- [x] Check wallet balance to enter event
- [x] Wallet functionalities
- [x] View attendees list (fix UI, create scroll)
- [x] Event-features
- [x] Private event logic (you can see them and request to join, but you don't join automatically)
- [x] Request to join a private event
- [x] Invite users to events
- [x] Manage events attended/to attend (basically leave events in profile upcoming events)
- [x] Add funds to wallet (AJAX)
- [x] Create "Event Invites" menu button
- [x] Create static pages
- [x] Website colors and other fine-tuning
- [x] Filter events by privacy
- [x] Filter events by tag
- [x] Event owner: Manage Event Visibility
- [x] Cancel attendance returns funds
- [x] Write stuff inside FAQ page
- [x] When owner deletes event, attendees get money back
- [x] Delete notifications sent
- [x] Owner can remove attendees from event
- [x] Polls in event page
- [x] Vote in comments (increasing likes and dislikes in database and showing them)
- [x] Comments in poll page
- [x] Only owner may add/remove polls (add/remove polls feature)
- [x] Add/Edit/Delete comments in each polls
- [x] Add/Edit/Delete polls from event
- [x] See all your comments in your profile
- [x] Delete event features
- [x] Report events
- [x] Report CRUD
- [x] Can only report each event once
- [x] Admin logic
- [x] Fix images
- [x] Attendees can Upload Files

### Vitor


### Nills 
- [x] Add stuff to About Us and Contact pages


# Project Requirements

## User
- [x] Browse Public Events
- [x] View Public Event
- [x] Explore Events by Tag
- [x] Search Events

## Auth User
- [x] Create Event
- [x] Invite Users to Public Event
- [x] Manage My Events
- [x] Manage Events Attended / to Attend
- [x] Request to Join Event
### --optional
- [x] Purchase Ticket to Event
- [x] Support Public/Private Events
- [x] Report Event
- [x] Manage Invitations Sent
- [x] Manage Invitations Received

## attendees
- [ ] View Event Messages **(comments??)**
- [x] Add Comments **(same as bellow??)**
- [x] Answer Polls **(add comment to poll??)**
- [x] Upload Files
- [x] Vote in Comments
- [x] View Attendees List
- [x] Leave Event
### --optional
- [ ] View Event Tickets **(what is this??????)**
...
- [x] Add User to Event (not instantly add, but send invite and user has to accept)
- [x] Manage Event Participants
- [x] Create Polls
- [x] Cancel Event
- [x] Manage Event Visibility
### --optional
- [x] Manage Available Tickets
- [x] Send Event Invitations
- [x] Manage Join Requests in Public Events
- [x] Access Statistics on Event Participation

## Notifications
- [x] invitiation to event
### --optional
- [x] response to join event

## admin
- [x] browse events
- [x] view event Details
- [x] manage event reports
- [x] delete event
